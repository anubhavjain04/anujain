...
<form name="actionForm" id="actionForm" action="" method="post">
	<div class="contentbox nopad" id="tabs-2">
        ...
        <div align="right">
            ...
            <a href="<?php echo Yii::app()->createUrl("/matrimonyCaste/create");?>" id="mul_add"> <img src="<?php echo Yii::app()->request->baseUrl;?>/img/icons/add.png" title="Add" alt="Add" /> </a>
        </div>


		<?php $this->widget('zii.widgets.grid.CGridView', array(
        	'cssFile'=>Yii::app()->request->baseUrl.'/css/gridview/styles.css',
            'id'=>'matrimony-caste-grid',
            ...
            'columns'=>array(				
						...
						array(
							...
							'header'=>CHtml::dropDownList(
										...
										array(
											'onchange'=>"$.fn.yiiGridView.update('matrimony-caste-grid',{ data:{pageSize: $(this).val() }})",
										)
									),                                
