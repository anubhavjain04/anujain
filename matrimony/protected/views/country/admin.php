...
<form name="actionForm" id="actionForm" action="" method="post">
	<div class="contentbox nopad" id="tabs-2">
        ...
        <div align="right">
            ...
            <a href="<?php echo Yii::app()->createUrl("/country/create");?>" id="mul_add"> <img src="<?php echo Yii::app()->request->baseUrl;?>/img/icons/add.png" title="Add" alt="Add" /> </a>
        </div>
            ...
            'columns'=>array(				
						...
						array(
							...
							'header'=>CHtml::dropDownList(
										...
										array(
											'onchange'=>"$.fn.yiiGridView.update('country-grid',{ data:{pageSize: $(this).val() }})",
										)
									),                                
