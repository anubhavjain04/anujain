...
function Convert_to_Kritidev_010(unicode_text)
{
...
var modified_substring = unicode_text;

//****************************************************************************************
//  Break the long text into small bunches of max. max_text_size  characters each.
//****************************************************************************************
    var text_size = unicode_text.length ;
   ...
   //************************************************************
    ...
    while ( chale_chalo == 1 ) 
    {
     ...
     { 
      sthiti2 +=  max_text_size ;
      while (unicode_text.charAt ( sthiti2 ) != ' ') {sthiti2--;}
     } 
     else  { sthiti2 = text_size  ;  chale_chalo = 0 }

     var modified_substring =unicode_text.substring ( sthiti1, sthiti2 )  ;
