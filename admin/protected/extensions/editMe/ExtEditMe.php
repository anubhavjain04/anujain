...
class ExtEditMe extends CInputWidget {
	 ...
	 */
	 // changes done by anubhav jain
	//public $filebrowserBrowseUrl = '../../pdw_file_browser/index.php?editor=ckeditor';
	public $filebrowserBrowseUrl = '/pdw_file_browser/index.php?editor=ckeditor';
	// changes done
	 ...
	 */
	  // changes done by anubhav jain
	//public $filebrowserImageBrowseUrl = '../../pdw_file_browser/index.php?editor=ckeditor&filter=image';
	public $filebrowserImageBrowseUrl = '/pdw_file_browser/index.php?editor=ckeditor&filter=image';
	// changes done
	...
	public function init() {
		// Changes done by anubhav jain
		$this->filebrowserImageBrowseUrl = Yii::app()->request->baseUrl.$this->filebrowserImageBrowseUrl;
		$this->filebrowserBrowseUrl = Yii::app()->request->baseUrl.$this->filebrowserBrowseUrl;
		// changes end
