...
<form name="actionForm" id="actionForm" action="" method="post">
	...
	<div align="right">
        ...
        <a href="<?php echo Yii::app()->createUrl("/magazine/create");?>"	id="mul_add"> 
...
'cssFile'=>Yii::app()->request->baseUrl.'/css/gridview/styles.css',
	...
	'columns'=>array(				
					...
					array(
						'name'=>'MagzineDate',
						'value'=>'$data->MagzineDate',
					),
					
					array(
						'name'=>'fkMagTypeId',
						'value'=>'$data->fkMagType->MagazineType',
					),
					array(
						'name'=>'Type',
						'value'=>'$data->Type',
					...
					'buttons'=>array(
						  'up'=>array(
							  ...
							  'url'=>'Yii::app()->createUrl("/magazine/publish?id=$data->pkMagazineId")',
							),
						  'down'=>array(
							  'label'=>'Unpublish',
							  'imageUrl'=>Yii::app()->request->baseUrl . '/img/icons/unpublish_small.png',
							  'url'=>'Yii::app()->createUrl("/magazine/unpublish?id=$data->pkMagazineId")',
							),
					),
