...
<div align="right">
    ...
    <a href="<?php echo Yii::app()->createUrl("/groupMaster/create");?>" id="mul_add"> <img src="<?php echo Yii::app()->request->baseUrl;?>/img/icons/add.png" title="Add" alt="Add" /> </a>
</div>
...
// change 'user-grid' to the actual id of your grid!!
								'onchange'=>"$.fn.yiiGridView.update('group-master-grid',{ data:{pageSize: $(this).val() }})",
)),
