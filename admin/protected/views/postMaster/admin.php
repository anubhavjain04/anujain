...
<div align="right"><a href="javascript:void(0);" id="multiple_delete"> <img
	...
	title="Unpublish" /> </a> <a
	href="<?php echo Yii::app()->createUrl("/postMaster/create");?>"
	id="mul_add"> <img
...
array(
						'name'=>'PostOrder',
						'value'=>'$data->PostOrder',
),

array(
						'name'=>'LevelCode',
						'value'=>'$data->LevelCode',
),
...
// change 'user-grid' to the actual id of your grid!!
								'onchange'=>"$.fn.yiiGridView.update('post-master-grid',{ data:{pageSize: $(this).val() }})",
)),
							'buttons'=>array(
							  'up'=>array(
								  'label'=>'Publish',
								  'imageUrl'=>Yii::app()->request->baseUrl . '/img/icons/publish_small.png',
								  'url'=>'Yii::app()->createUrl("/postMaster/publish?id=$data->pkPostId")',
),
							  'down'=>array(
								  'label'=>'Unpublish',
								  'imageUrl'=>Yii::app()->request->baseUrl . '/img/icons/unpublish_small.png',
								  'url'=>'Yii::app()->createUrl("/postMaster/unpublish?id=$data->pkPostId")',
),
),
