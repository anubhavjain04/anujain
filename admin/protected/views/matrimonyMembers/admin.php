						...
						array(
							...
							'buttons'=>array(
								...
								'payment'=>array(
									  ...
									  'imageUrl'=>Yii::app()->request->baseUrl . '/img/icons/rupee.png',
									  'url'=>'Yii::app()->createUrl("/matrimonyMemberPayment/admin/id/$data->pkMemberId")',
									),		
							),		                                
							'viewButtonLabel'=>yii::t('core','View'),
							'updateButtonLabel'=>yii::t('core','Update'),
							'deleteButtonLabel'=>yii::t('core','Delete'),
							'template'=> '{up} {down} {view} {update} {delete} {login} {payment}',
        				),
        			),
        )); ?>
	</div>
