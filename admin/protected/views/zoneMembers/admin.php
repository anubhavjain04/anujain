...
<div align="right"><a href="javascript:void(0);" id="multiple_delete"> <img
	...
	title="Unpublish" /> </a> <a
	href="<?php echo Yii::app()->createUrl("/zoneMembers/create");?>"
	id="mul_add"> <img
...
array(
						'name'=>'fkZoneId',
						'value'=>'$data->fkZone != null? "Zone-".$data->fkZone->ZoneCode : ""',
						'header'=>'Zone'
),
...
// change 'user-grid' to the actual id of your grid!!
								'onchange'=>"$.fn.yiiGridView.update('zone-members-grid',{ data:{pageSize: $(this).val() }})",
)),
							'buttons'=>array(
							  'up'=>array(
								  'label'=>'Publish',
								  'imageUrl'=>Yii::app()->request->baseUrl . '/img/icons/publish_small.png',
								  'url'=>'Yii::app()->createUrl("/zoneMembers/publish?id=$data->pkZoneMember")',
),
							  'down'=>array(
								  'label'=>'Unpublish',
								  'imageUrl'=>Yii::app()->request->baseUrl . '/img/icons/unpublish_small.png',
								  'url'=>'Yii::app()->createUrl("/zoneMembers/unpublish?id=$data->pkZoneMember")',
),
),
