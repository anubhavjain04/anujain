...
<div align="right"><a href="javascript:void(0);" id="multiple_delete"> <img
	...
	title="Unpublish" /> </a> <a
	href="<?php echo Yii::app()->createUrl("/functionMaster/create");?>"
	id="mul_add"> <img
...
array(
						...
						'value'=>'FunctionMaster::getFunctionCode($data->parentFunctionId)',
),
...
// change 'user-grid' to the actual id of your grid!!
								'onchange'=>"$.fn.yiiGridView.update('function-master-grid',{ data:{pageSize: $(this).val() }})",
)),
							'buttons'=>array(
							  'up'=>array(
								  'label'=>'Publish',
								  'imageUrl'=>Yii::app()->request->baseUrl . '/img/icons/publish_small.png',
								  'url'=>'Yii::app()->createUrl("/functionMaster/publish?id=$data->pkfunctionId")',
),
							  'down'=>array(
								  'label'=>'Unpublish',
								  'imageUrl'=>Yii::app()->request->baseUrl . '/img/icons/unpublish_small.png',
								  'url'=>'Yii::app()->createUrl("/functionMaster/unpublish?id=$data->pkfunctionId")',
),
),
