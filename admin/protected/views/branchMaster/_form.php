...
<div class="row">
    ...
    <?php 
        ...
        if(isset($allZones)){
         ...
         ?>
    <?php echo $form->dropDownList($model,'fkZoneId',$zoneArray,array('prompt'=>'[Select Zone]')); ?>        
    <?php echo $form->error($model,'fkZoneId'); ?>
</div>

<div class="row"><?php echo $form->labelEx($model,'RunningStatus'); ?> <?php
echo $form->dropDownList($model,'RunningStatus',array('1'=>'Active', '0'=>'Inactive'));
?> <?php echo $form->error($model,'RunningStatus'); ?></div>
