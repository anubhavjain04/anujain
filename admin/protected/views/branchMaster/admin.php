...
array(
						'name'=>'RunningStatus',
						'value'=>'$data->RunningStatus==1 ? "Active" : "Inactive"',
						'filter'=>CHtml::dropDownList('BranchMaster[RunningStatus]', $model->RunningStatus,  
									array(''=>'All','1'=>'Active','0'=>'Inactive'),
