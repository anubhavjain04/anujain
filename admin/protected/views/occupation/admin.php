...
<form name="actionForm" id="actionForm" action="" method="post">
	<div class="contentbox nopad" id="tabs-2">
        ...
        <div align="right">
            ...
            <a href="<?php echo Yii::app()->createUrl("/occupation/create");?>" id="mul_add"> <img src="<?php echo Yii::app()->request->baseUrl;?>/img/icons/add.png" title="Add" alt="Add" /> </a>
        </div>
		...
		<?php $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'columns'=>array(				
						...
						array(
							'name'=>'fkOccGroupId',
							'value'=>'$data->fkOccGroup->GroupName',
						),						
						array(
							'name'=>'OccupationName',
						...
						array(
							...
							'header'=>CHtml::dropDownList(
										...
										array(
											'onchange'=>"$.fn.yiiGridView.update('occupation-grid',{ data:{pageSize: $(this).val() }})",
										)
									),                                
