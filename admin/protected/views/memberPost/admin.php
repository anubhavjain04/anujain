...
<div align="right"><a href="javascript:void(0);" id="multiple_delete"> <img
	...
	title="Delete" /> </a> <a
	href="<?php echo Yii::app()->createUrl("/memberPost/create");?>"
	id="mul_add"> <img
...
array(
						'name'=>'fkPostId',
						'value'=>'$data->fkPost != null? $data->fkPost->PostName : ""',
						'header'=>'Post Name'
),
...
// change 'user-grid' to the actual id of your grid!!
								'onchange'=>"$.fn.yiiGridView.update('member-post-grid',{ data:{pageSize: $(this).val() }})",
)),
