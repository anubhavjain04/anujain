...
<div align="right"><a href="javascript:void(0);" id="multiple_delete"> <img
	...
	title="Unpublish" /> </a> <a
	href="<?php echo Yii::app()->createUrl("/functionGroupAuth/create");?>"
	id="mul_add"> <img
...
array(
						'name'=>'fkfunctionId',
						'value'=>'$data->fkfunction->functionName',
),
...
// change 'user-grid' to the actual id of your grid!!
								'onchange'=>"$.fn.yiiGridView.update('function-group-auth-grid',{ data:{pageSize: $(this).val() }})",
)),
							'buttons'=>array(
							  'up'=>array(
								  'label'=>'Publish',
								  'imageUrl'=>Yii::app()->request->baseUrl . '/img/icons/publish_small.png',
								  'url'=>'Yii::app()->createUrl("/functionGroupAuth/publish?id=$data->pkgroupAuthId")',
),
							  'down'=>array(
								  'label'=>'Unpublish',
								  'imageUrl'=>Yii::app()->request->baseUrl . '/img/icons/unpublish_small.png',
								  'url'=>'Yii::app()->createUrl("/functionGroupAuth/unpublish?id=$data->pkgroupAuthId")',
),
),
