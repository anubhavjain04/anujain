...
class LevelMasterController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('LevelMaster');
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='level-master-form')
		{
	...
	public function multipleDelete($data)
	{
		...
		$arr=implode(',',$data['level-master-grid_c0']);
		$query = "delete from level_master where pkLevel in(".$arr.")";
