...
class GroupMasterController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['GroupMaster']))
		{
			...
			$checkModel = new GroupMaster();
			$criteria1=new CDbCriteria;
			$criteria1->condition = "GroupName='".$model->GroupName."'";
			$modelData = $checkModel->findAll($criteria1);
			
			if(count($modelData)>0){
				$model->addError('GroupName','This group name is already exists.');
			}else{
				if($model->save())
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['GroupMaster']))
		{
			...
			$checkModel = new GroupMaster();
			$criteria1=new CDbCriteria;
			$criteria1->condition = "GroupName='".$model->GroupName."' and pkGroupId!=".$id;
			$modelData = $checkModel->findAll($criteria1);
	...
	public function multipleDelete($data)
	{
		...
		$arr=implode(',',$data['group-master-grid_c0']);
		$query = "delete from group_master where pkGroupId in(".$arr.")";
