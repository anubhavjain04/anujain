		...
		if($_POST){
			...
			if($model->validatePassword($oldPassword)){
				if(strlen($newPassword)>=8) {
					...
					throw new CHttpException(403,'New password length should be greater than or equal to 8 characters.');
				}
			}else {
				throw new CHttpException(403,'Your old password does not match.');
			}
		}else{
