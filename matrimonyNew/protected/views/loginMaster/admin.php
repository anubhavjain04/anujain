...
<form name="actionForm" id="actionForm" action="" method="post">
  <div class="contentbox nopad" id="tabs-2">
    ...
    <div align="right">
        ...
        <a href="<?php echo Yii::app()->createUrl("/loginMaster/create");?>" id="mul_add"> 
...
'cssFile'=>Yii::app()->request->baseUrl.'/css/gridview/styles.css',
	...
	'columns'=>array(				
					...
					array(
						'name'=>'fkgroup',
						'value'=>'is_null($data->fkgroup)? "" : $data->fkgroup->groupName',
					),
					array(
						'name'=>'Status',
					...
					array(
						...
						// change 'user-grid' to the actual id of your grid!!
							'onchange'=>"$.fn.yiiGridView.update(login-master-grid',{ data:{pageSize: $(this).val() }})",
						)),
						'buttons'=>array(
						  'up'=>array(
							  'label'=>'Publish',
							  'imageUrl'=>Yii::app()->request->baseUrl . '/img/icons/publish_small.png',
							  'url'=>'Yii::app()->createUrl("/loginMaster/publish?id=$data->pkLoginId")',
							),
						  'down'=>array(
							  'label'=>'Unpublish',
							  'imageUrl'=>Yii::app()->request->baseUrl . '/img/icons/unpublish_small.png',
							  'url'=>'Yii::app()->createUrl("/loginMaster/unpublish?id=$data->pkLoginId")',
							),
						),
