...
class GalleryController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Gallery']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->pkGalleryId));
		}
	...
	// This function will return all videos.
	...
	// This function will return all audios.
	public function actionAudios(){	
		$this->render('audios',array(
			'model'=>$this->galleryModel()
		));
	}
	 ...
	 */
	protected function galleryModel()
	{
		if (isset($_GET['pageSize'])) {
			Yii::app()->user->setState('pageSize',(int)$_GET['pageSize']);
			unset($_GET['pageSize']);  // would interfere with pager and repetitive page size change
