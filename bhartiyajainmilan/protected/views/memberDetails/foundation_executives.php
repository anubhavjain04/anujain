<?php $this->pageTitle="Bhartiya Jain Milan-Foundation Executives" ?>
<div id="content">
  <div class="wrapper">
    <div class="col-1 ">
      <div class="row-1 p4">
                    ...
                    <div class="corner-top-right">
                      <div class="corner-bot-left">
                        <div class="corner-bot-right">
                          <div class="padding">
                            <h2 class="title-1">Bhartiya Jain Milan Foundation</h2>
                            <h3 class="title-1"><strong>Foundation Present Executives</strong></h3>
                            <?php 
