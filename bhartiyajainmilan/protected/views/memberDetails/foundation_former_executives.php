<?php $this->pageTitle="Bhartiya Jain Milan-Foundation Former Executives | Leaders" ?>
<div id="content">
  <div class="wrapper">
    <div class="col-1 ">
      <div class="row-1 p4">
                      ...
                      <div class="corner-bot-left">
                        <div class="corner-bot-right">
                          <div class="padding">
                            ...
                            <h3 class="head1">Foundation <strong>Former Executives</strong></h3>
                            <?php 
                                    ...
                                    <td>
                                    	<ul class="ullist">
											...
											*/ ?>
                                            <li class="color-9">
                                            	<div class="left">
                                            	Period: <?php echo date('F Y',strtotime($boardMembers[$i]["AssignDate"]));  ?>
                                                 to
                                                	<?php
														if($boardMembers[$i]["TillDate"]!=null)	{
															echo date('F Y',strtotime($boardMembers[$i]["TillDate"]));
														}else{
															echo "Till Now";
														}
													?>
