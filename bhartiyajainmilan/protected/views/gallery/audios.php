...
?>
<?php $this->pageTitle="Gallery | Events | Function | Audios" ?>
                        ...
                        <div>
                            ...
                            <form name="actionForm" id="actionForm" action="" method="post">
                                <div style="color: #FF0000;">
                                    <?php if(isset($_GET['msg']) && !empty($_GET['msg'])) { echo $_GET['msg']; } ?>
                                </div>
                                <?php
                                ...
                                <div id="grid-data">
                                    ...
                                    <div class="alignright">Displaying <?php echo $start; ?>-<?php echo $end; ?> of
                                        <?php echo $total; ?> results.</div>
                                    <div class="gallery list">
                                        <div class="gVideos p2">
                                            ...
                                            <div class="gVideo">
                                                ...
                                                <div>
                                                    <strong><?php echo date('d F Y',strtotime($item->date)); ?></strong>
                                                </div>
                                    ...
                                    ?>
                                    <input type="hidden" id="grid-data_pageURL"
                                        value="<?php echo Yii::app()->createUrl(Yii::app()->controller->getId().'/'.Yii::app()->controller->getAction()->getId(),$_GET); ?>" />
                                    <input type="hidden" id="grid-data_searchURL"
                                        value="<?php echo Yii::app()->createUrl(Yii::app()->controller->getId().'/'.Yii::app()->controller->getAction()->getId()); ?>" />
                                </div>
                                <?php
                                    } else {
                                        echo '<div id="grid-data"> No audios uploaded.</div>';
                                    }
                                ?>
                            </form>
                        </div>
